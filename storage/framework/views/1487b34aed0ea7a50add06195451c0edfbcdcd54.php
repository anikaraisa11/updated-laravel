    ...
    <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="275px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_toggle">
									...
									<div class="menu-item px-3">
										<div class="menu-content d-flex align-items-center px-3">
											...
											<div class="d-flex flex-column">
												<div class="fw-bold d-flex align-items-center fs-5">Anika Raisa
												<span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Pro</span></div>
												<a href="#" class="fw-semibold text-muted text-hover-primary fs-7">anika@raisa11.com</a>
											</div>
											<!--end::Username-->
										</div>
									</div>
							...
							<div id="kt_app_sidebar_nav_wrapper" class="d-flex flex-column hover-scroll-y pe-4 me-n4" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar, #kt_app_sidebar_nav" data-kt-scroll-offset="5px">
								...
								<div class="d-flex mb-3 mb-lg-6">
									...
									<div class="border border-gray-300 border-dashed rounded min-w-100px w-100 py-2 px-4 me-6">
										<!--begin::Date-->
										<span class="fs-6 text-gray-500 fw-bold">Meeting Attended</span>
										<!--end::Date-->
										<!--begin::Label-->
										<div class="fs-2 fw-bold text-success">350</div>
										<!--end::Label-->
									</div>
									<!--end::Stat-->
									<!--begin::Stat-->
									<div class="border border-gray-300 border-dashed rounded min-w-100px w-100 py-2 px-4">
										<!--begin::Date-->
										<span class="fs-6 text-gray-500 fw-bold">Upcoming Meetings</span>
										<!--end::Date-->
										<!--begin::Label-->
										<div class="fs-2 fw-bold text-danger">29</div>
										<!--end::Label-->
									</div>
									<!--end::Stat-->
								</div>
								...
								<div class="mb-6">
									...
									<div class="row row-cols-2 row-cols-lg-3" data-kt-buttons="true" data-kt-buttons-target="[data-kt-button]">
										...
										<div class="col mb-4">
											<!--begin::Link-->
											<a href="/create" class="btn btn-icon btn-outline btn-bg-light btn-active-light-primary btn-flex flex-column flex-center w-90px h-90px border-gray-200" data-kt-button="true">
												<!--begin::Icon-->
												<span class="mb-2">
												...
												<!--end::Icon-->
												<!--begin::Label-->
												<span class="fs-7 fw-bold">Virtual Conferences</span>
												<!--end::Label-->
											</a>
											<!--end::Link-->
										</div>
										...
										<div class="col mb-4">
											<!--begin::Link-->
											<a href="" class="btn btn-icon btn-outline btn-bg-light btn-active-light-primary btn-flex flex-column flex-center w-90px h-90px border-gray-200" data-kt-button="true">
												<!--begin::Icon-->
												<span class="mb-2">
													<i class="fonticon-like-1 fs-2"></i>
												</span>
												<!--end::Icon-->
												<!--begin::Label-->
												<span class="fs-7 fw-bold">Virtual Exhibitions</span>
												<!--end::Label-->
											</a>
											<!--end::Link-->
										</div>
										...
										<div class="col mb-4">
											...
											<a href="" class="btn btn-icon btn-outline btn-bg-light btn-active-light-primary btn-flex flex-column flex-center w-90px h-90px border-gray-200" data-kt-button="true">
												...
												<!--end::Icon-->
												<!--begin::Label-->
												<span class="fs-7 fw-bold">Virtual Education Fair</span>
												<!--end::Label-->
											</a>
											<!--end::Link-->
										</div>
										...
										<div class="col mb-4">
											...
											<a href="" class="btn btn-icon btn-outline btn-bg-light btn-active-light-primary btn-flex flex-column flex-center w-90px h-90px border-gray-200" data-kt-button="true">
												<!--begin::Icon-->
												<span class="mb-2">
													<i class="fonticon-line-chart fs-2"></i>
												</span>
												<!--end::Icon-->
												<!--begin::Label-->
												<span class="fs-7 fw-bold">Events Notify</span>
												<!--end::Label-->
											</a>
											<!--end::Link-->
										</div>
										...
										<div class="col mb-4">
											<!--begin::Link-->
											<a href="../../demo23/dist/apps/contacts/add-contact.html" class="btn btn-icon btn-outline btn-bg-light btn-active-light-primary btn-flex flex-column flex-center w-90px h-90px active border-primary border-dashed" data-kt-button="true">
												<!--begin::Icon-->
												<span class="mb-2">
					...
					<!--end::Sidebar--><?php /**PATH C:\xampp\htdocs\Internship\eMeeting\Metronic\resources\views/includes/sidemenu.blade.php ENDPATH**/ ?>